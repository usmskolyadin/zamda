        ...
        <div className="max-w-screen-xl lg:flex mx-auto">
          ...
          <div className=" lg:w-3/4 lg:ml-24">
            ...
            <div className="lg:flex">
                <h1 className="w-2/3 text-black font-bold lg:text-4xl text-3xl lg:py-4 lg:py-1 py-4">My Favorites</h1>
            </div>
            ...
            <div className="flex flex-col">
                <Link href={"/category/subcategory/ad_name"}>
                    <div className="lg:flex mt-4 min-w-full bg-gray-100 rounded-2xl p-2">
                        <div className="mr-4">
                            <Image src={"/mashink.png"} alt={""} className="rounded-2xl lg:h-48  lg:w-72 w-full object-cover" objectFit="cover" width={10000} height={10000} />
                        </div>
                        <div className="w-full lg:mr-4 lg:mt-0 mt-2">
                            <div className="w-full flex items-center justify-between">
                                <h1 className="text-xl text-black font-bold">Ford F-150 3.5 AT, 2025</h1>
                                <h1 className="text-sm text-gray-500">27 Jul</h1>
                            </div>
                            <div className="flex w-full">
                                <p className="text-md text-gray-600 mr-2">€142.83</p>
