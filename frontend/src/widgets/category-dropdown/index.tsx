  ...
  return (
    <div className="relative inline-block">
      <button
        ...
        className={`rounded-3xl cursor-pointer p-4 h-[44px] w-[188px] flex justify-center items-center transition-colors duration-200
          ${open ? "bg-[#E5E9F2] text-black" : "bg-black text-white"}`}
      >
        <span className={open ? "text-black" : "text-white"}>All categories</span>
        <svg
