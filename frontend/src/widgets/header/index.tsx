...
export default function Header() {
  ...
  return (
        <div className="fixed top-0 w-full z-50">
              ...
              <div className="flex">
                ...
                <Link href={"/cart"}>
                  <svg className="mr-3" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20.3125 22.9165C21.1754 22.9165 21.875 22.2169 21.875 21.354C21.875 20.4911 21.1754 19.7915 20.3125 19.7915C19.4496 19.7915 18.75 20.4911 18.75 21.354C18.75 22.2169 19.4496 22.9165 20.3125 22.9165Z" fill="white" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M9.89575 22.9165C10.7587 22.9165 11.4583 22.2169 11.4583 21.354C11.4583 20.4911 10.7587 19.7915 9.89575 19.7915C9.0328 19.7915 8.33325 20.4911 8.33325 21.354C8.33325 22.2169 9.0328 22.9165 9.89575 22.9165Z" fill="white" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M5.20825 4.16683H22.9166L20.8333 15.6252H7.29159L5.20825 4.16683ZM5.20825 4.16683C5.03464 3.47238 4.16659 2.0835 2.08325 2.0835L5.20825 4.16683Z" fill="white"/>
                    <path d="M5.20825 4.16683H22.9166L20.8333 15.6252H7.29159L5.20825 4.16683ZM5.20825 4.16683C5.03464 3.47238 4.16659 2.0835 2.08325 2.0835" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M20.8334 15.625H7.29175H5.4488C3.59014 15.625 2.60425 16.4388 2.60425 17.7083C2.60425 18.9779 3.59014 19.7917 5.4488 19.7917H20.3126" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </Link>

              </div>
      
                <button className="bg-[#2AAEF7] rounded-3xl h-[36px] w-[200px] text-white flex items-center text-center justify-center">
                  <div className="flex items-center">
                    ...
                    <Link href="/new">Place an ad</Link>
                  </div>
                </button>
                {user ? (
                <Link href={"/listings"}>
          ...
          <nav className="flex lg:h-[114px] h-[164px] bg-white items-center shadow-xs p-4 ">
            <div className="max-w-screen-xl mx-auto lg:flex items-center w-full justify-between">
              ...
              <div className="lg:flex hidden items-center">
                ...
                <p className="ml-2 text-black">{user?.profile.city ? (user?.profile.city) : (<>Set your city</>) }</p>
              </div>
            </div>
          </nav>
        </div>
